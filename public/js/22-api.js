...
function normaliseUser(u){
  ...
  return{id:u.id,name:nm,email:u.email,role:primaryRole,roles:roles,empId:u.employee_id,desig:u.designation,plt:u.platform||'Gmail',ooo:u.ooo_until||null,av:initials.toUpperCase()||'?',avc:roleAvc[primaryRole]||'av-ra',bdm:null,managerId:u.manager_id||null,managerName:(u.manager&&u.manager.name)||'',teamName:u.team_name||''};
}
